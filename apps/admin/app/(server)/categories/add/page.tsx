...
export default function AddCategoryPage() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-xl font-semibold text-gray-900">Thêm danh mục Tour</h1>
        <p className="mt-1 text-sm text-gray-500">Điền thông tin để tạo danh mục tour mới</p>
      </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-5 px-6 py-6">
            ...
            <div className="space-y-1">
              ...
              <textarea name="introduce" rows={3} placeholder="Mô tả ngắn gọn..." className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-gray-900 focus:outline-none resize-y" />
            </div>
          </div>
