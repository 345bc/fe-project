    ...
    <>
      <nav className="sticky top-0 w-full z-100 bg-surface py-3 shadow-xl">
        <div className="flex justify-between items-center container-main mx-auto md:px-12">
          ...
          {/* Menu Links */}
          <div className="hidden md:flex gap-10 font-bold text-base uppercase tracking-widest transition-colors duration-300 text-primary">
            <DropdownMenu />
          ...
          <div className="flex items-center gap-1 md:gap-3">
            ...
            <button
              ...
              className="md:hidden block p-2 ml-1 rounded-full hover:bg-zinc-400 transition-colors duration-300 text-primary "
