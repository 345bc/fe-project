    ...
    <main className="flex min-h-screen bg-surface">
      ...
      <section className="relative flex w-full lg:w-1/2 justify-center p-4 sm:p-6 md:p-8 lg:p-12  lg:mt-0">
        <div className=" absolute z-50 top-4 right-0 px-5">
          {error && (
            <div className="overflow-hidden max-w-72 bg-ghostwhite z-50  whitespace-pre-line  rounded-lg border border-primary  p-3 ">
          ...
          {success && (
            <div className="overflow-hidden max-w-72 whitespace-pre-line z-50 bg-ghostwhite rounded-lg border border-primary  p-3 ">
