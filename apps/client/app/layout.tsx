  ...
  return (
    <html lang="vi" className={`${inter.variable} ${poppins.variable}`}>
      ...
      <body className="bg-surface text-on-surface font-body antialiased">
        ...
        {/* Footer */}
        <footer className="bg-surface-container-low text-slate-900  pb-12 overflow-hidden border-t border-slate-200">
          <div className="container-main mx-auto px-8 relative">
            {/* 2. Main Content Grid */}
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-t border-slate-200 pt-16">
              {/* Cột 1: Thông tin thương hiệu & Social */}
              <div className="lg:col-span-4 space-y-8">
                <div className="text-4xl font-black tracking-tighter">
                  ZTravel<span className="text-primary">.</span>
                </div>
                <p className="text-slate-500 leading-relaxed font-body italic max-w-sm">
                  "Chúng tôi không chỉ bán những chuyến đi, chúng tôi kiến tạo
                  những chương mới trong cuốn sách cuộc đời bạn."
                </p>

                {/* Social Icons với màu sắc chuẩn hãng */}
              ...
              <div className="lg:col-span-2 lg:col-start-6">
                <h4 className="font-bold mb-8 text-xs uppercase tracking-[0.2em] text-slate-400">
                  Danh mục
                </h4>
                <ul className="space-y-4 font-bold text-lg font-headline">
                  <li>
                    <Link
                      href="#"
                      className="hover:underline decoration-primary decoration-2 underline-offset-8 transition-all"
                    >
                      Miền Bắc
                    </Link>
                  </li>
              ...
              <div className="lg:col-span-2">
                ...
                <ul className="space-y-4 font-medium text-slate-600 font-body text-sm">
                  <li>
                    <Link
                      href="#"
            ...
            {/* 3. Bottom Footer Bar */}
            <div className="mt-24 pt-8 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">
              <div>© 2026 Zella Ecosystem — ZTravel Studio</div>
              <div className="flex items-center gap-8">
                <div className="flex gap-4 grayscale opacity-40 hover:grayscale-0 transition-all">
